...
public class StaffListAdapterSetBonus extends RecyclerView.Adapter<StaffListAdapterSetBonus.ViewHolder>  {

    private Context mContext;
    private ArrayList<Staff> staffs;

    public StaffListAdapterSetBonus(Context mContext, ArrayList<Staff> staffs) {
    ...
    @NonNull
    @Override
    public StaffListAdapterSetBonus.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mContext);
        View heroView = inflater.inflate(R.layout.item_staff_set_salary, parent, false);
        StaffListAdapterSetBonus.ViewHolder viewHolder = new StaffListAdapterSetBonus.ViewHolder(heroView);
        return viewHolder;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull StaffListAdapterSetBonus.ViewHolder holder, final int position) {
        ...
        holder.btnCaiDat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                View promptsView = layoutInflater.inflate(R.layout.set_salary, null);
                ...
                alertDialogBuilder.setTitle(R.string.nhapThuongTheoThang);
                ...
                final Button btnApDungTatCa = promptsView.findViewById(R.id.btnApDungTatCa);
                final Button btnHuy = promptsView.findViewById(R.id.btnHuy);
                ...
                btnApDung.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        staffs.get(position).setTienThuong(s.getTienThuong() + khoanTien);
